...
"""
Extracts the embedding (or another variable) from a model trained by
lstm_lm.py.
"""
...
def parse_arguments():
    parser = ArgumentParser(
        description='Extracts the embedding (or another variable) from a model '
                    'trained by lstm_lm.py.')
    ...
    parser.add_argument('--variable', '-v', default='Model/embedding',
                        help='the full scope of the variable [Model/embedding]')
